...
![Rust](https://img.shields.io/badge/Rust-F07F38?style=flat&logo=rust&logoColor=white)
...
| <div align="center" ><img src="https://iili.io/C5QpXcX.md.png" height="30px" width="auto" /></div> <div align="center">`Autoraja` </div>| Autoraja Rickshaw is India's driver-first auto-rickshaw platform, built to create fairer earnings for drivers and better prices for passengers. Unlike traditional ride-hailing apps, Autoraja operates on a zero-commission model, allowing drivers to keep 100% of every fare while passengers enjoy transparent pricing with no surge charges. Together, we're building a smarter, fairer future for urban mobility. | ![React](https://img.shields.io/badge/React-61DAFB?style=flat&logo=react&logoColor=white) ![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat&logo=node.js&logoColor=white) ![Express](https://img.shields.io/badge/Express-000000?style=flat&logo=express) ![Expo](https://img.shields.io/badge/Expo-232?style=flat&logo=expo)|
